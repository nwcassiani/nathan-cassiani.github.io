...
function toDashCase(string) {
    ...
    // return string with space replaced with dash, forced to lower case
    // replacement needs to be global => / /g
...
function beginsWith(string, char) {
    // YOUR CODE BELOW HERE //
    // determine if string[0] matches char, case insensitive
...
function endsWith(string, char) {
    // YOUR CODE BELOW HERE //
    // determine if last character in string matches char, using .length-1
...
function concat(stringOne, stringTwo) {
    // YOUR CODE BELOW HERE //
    // return strings concatenated using + operator
...
function join(stringOne, stringTwo) {
    ...
    // return args joined into string, removing comma separator
    return args.join("");
...
function longest(stringOne, stringTwo) {
    // YOUR CODE BELOW HERE //
    // compare strings using length property, return the longer string
